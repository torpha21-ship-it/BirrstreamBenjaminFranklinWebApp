  ...
  return (
    <div className="px-4 pt-4 pb-6 space-y-4 max-w-md mx-auto relative">
      ...
      <div className="bg-[#1A1A1A] rounded-3xl px-6 pt-3 pb-6 text-white relative z-10 overflow-hidden -mx-4">
        <img src={pointingHand} alt="" aria-hidden="true" className="absolute -right-[50px] top-0 h-1/2 object-contain object-right-top pointer-events-none select-none opacity-90" />
