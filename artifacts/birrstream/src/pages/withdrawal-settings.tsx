...
const BANKS = ["Commercial Bank of Ethiopia (CBE)", "Dashen Bank", "Awash Bank", "Bank of Abyssinia", "Cooperative Bank of Oromia", "Telebirr Wallet", "CBE Birr", "HelloCash", "M-Pesa Ethiopia"];
